...
static void lower_constant(const Machine &mach, const Constant *constant, 
    ...
    if (auto integer = dynamic_cast<const Integer*>(constant)) {
        ...
        data.push_back(new MachineConstant(kind, value));
        ...
        data.push_back(new MachineConstant(MachineConstant::Kind::Int64, 0L));
        ...
        for (uint32_t i = 0, e = value.size(); i < e; ++i) {
            ...
            switch (value[i]) {
                case '\\':
                    data.push_back(new MachineConstant(kind, (long) '\\'));
                    data.push_back(new MachineConstant(kind, (long) '\\'));
                    break;
                case '\'':
                    data.push_back(new MachineConstant(kind, (long) '\\'));
                ...
                case '\n':
                    data.push_back(new MachineConstant(kind, (long) '\\'));
                    data.push_back(new MachineConstant(kind, (long) 'n'));
                    break;
                case '\t':
                    data.push_back(new MachineConstant(kind, (long) '\\'));
                    data.push_back(new MachineConstant(kind, (long) 't'));
                    break;
                case '\r':
                    data.push_back(new MachineConstant(kind, (long) '\\'));
                    data.push_back(new MachineConstant(kind, (long) 'r'));
                    break;
                case '\b':
                    data.push_back(new MachineConstant(kind, (long) '\\'));
                    data.push_back(new MachineConstant(kind, (long) 'b'));
                    break;
                case '\0':
                    data.push_back(new MachineConstant(kind, (long) '\\'));
                    data.push_back(new MachineConstant(kind, (long) '0'));
                    break;
                default:
                    data.push_back(new MachineConstant(kind, ch));
                    break;
            }
        }
