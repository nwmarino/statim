...
Target::Target(Arch arch, ABI abi, OS os) : m_arch(arch), m_abi(abi), m_os(os) {
    ...
    m_rules[Type::TK_Int8] = { 1, 1 };
    m_rules[Type::TK_Int16] = { 2, 2 };
    m_rules[Type::TK_Int32] = { 4, 4 };
    m_rules[Type::TK_Int64] = { 8, 8 };
    m_rules[Type::TK_Float32] = { 4, 4 };
    m_rules[Type::TK_Float64] = { 8, 8 };
}

u32 Target::get_type_size(const Type* type) const {
    ...
    default:
        return m_rules.at(type->get_kind()).size;
    }
}
